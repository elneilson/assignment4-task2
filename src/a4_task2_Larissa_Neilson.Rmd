...
This report provides an exploratory overview of the differences in juvenile snowshoe hare sizes observed at the Bonanza Creek Experimental Forest (Long Term Ecological Research site). This overview explores 1) the comparison of juvenile hare weight between males and females, and 2) the relationship between juvenile hare hind foot length and weight (Kielland et  al. 2017).
